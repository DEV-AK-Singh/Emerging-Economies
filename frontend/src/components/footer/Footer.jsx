        ...
        <div className="mx-auto max-w-screen-xl px-4 pt-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-100 py-8">
            <p className="text-center text-xs/relaxed text-gray-500">
              ...
              <br />Created with <a href="https://react.dev/" className="underline text-blue-500"> ReactJs</a> and <a href="https://expressjs.com/" className="underline text-blue-500"> ExpressJs.</a>
            </p>
          </div>
        </div>
      </footer>
